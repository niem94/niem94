...
- 🔭 I’m currently researching how to set up a GitOps Workflow for my HashiCorp cluster running on 3 RPis. I want to optimize the pipeline, so it is faster and less cumbersome to deploy from GitHub to the cluster. <!---- 🌱 I’m currently learning about . -->
